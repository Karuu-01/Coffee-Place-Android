...
public class Offer {
     ...
     * @param room
     */
    public Offer(String id, String checkInDate, String checkOutDate, String rateCode, RateFamilyEstimated rateFamilyEstimated, Room room, Guests guests, Price price, Policies policies, String self) {
        super();
        this.id = id;
